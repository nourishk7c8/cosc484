	...
	<html>
	<head>
		<title>Merchandise by Quality</title><link rel="stylesheet" href="Assignment1.css"/>
		<style>
			footer ul li {
				font-size: 0.7em;
				list-style: none; 
	...
	<th>Quantity</th></tr>
	<?php if(!empty($_POST['quality'])) {
	/* echo "<table border=1>
	<tr><th>Merch ID</th><th>Item Name</th><th>Year</th><th>Quality</th><th>Price</th>
	<th>Quantity</th></tr>";*/
	 include 'db.inc.php';
	 ...
	 $query = "SELECT * FROM merch WHERE quality='$quality'";
